                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">
                                {{ \Carbon\Carbon::parse($consultation->patient->birth_date)->format('F j, Y') }}</p>
                        </div>
                    </div>
                    <hr class="my-2">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="  {{ $laboratory->lab_name }}"
                                            disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $laboratory->lab_des }}"
                                            disabled>
                                    </div>
                                </div>
                            </div>
